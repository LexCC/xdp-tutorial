...
sudo bpftool prog load cgroup-sock-drop.o /sys/fs/bpf/cgroup-sock-drop map name reservation_ops_map pinned /sys/fs/bpf/reservation_ops_map map name existed_connection_map pinned /sys/fs/bpf/existed_connection_map type cgroup/skb
