...
sudo bpftool prog load bpf_sockops.o /sys/fs/bpf/bpf_sockops map name reservation_ops_map pinned /sys/fs/bpf/reservation_ops_map map name existed_counter_map pinned /sys/fs/bpf/existed_counter_map map name burst_connection_map pinned /sys/fs/bpf/burst_connection_map map name lb_ips_map pinned /sys/fs/bpf/lb_ips_map
...
sudo bpftool prog load cgroup-sock-drop.o /sys/fs/bpf/cgroup-sock-drop map name reservation_ops_map pinned /sys/fs/bpf/reservation_ops_map map name existed_counter_map pinned /sys/fs/bpf/existed_counter_map map name burst_connection_map pinned /sys/fs/bpf/burst_connection_map map name lb_ips_map pinned /sys/fs/bpf/lb_ips_map type cgroup/skb
