...
sudo bpftool prog load bpf_sockops.o /sys/fs/bpf/bpf_sockops map name sock_ops_map pinned /sys/fs/bpf/sock_ops_map map name reservation_ops_map pinned /sys/fs/bpf/reservation_ops_map
